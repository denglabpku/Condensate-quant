...
Example and raw data information is listed in:
...
`Step2_deconvolution-segmentation/` also contains an example input file and generated outputs, which can be used to inspect the expected file naming and output organization.
...
- Several scripts contain example absolute paths. Update them to match your local data paths before running.
